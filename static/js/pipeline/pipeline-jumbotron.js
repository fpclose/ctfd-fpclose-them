...
/**
 * Pipeline Background for CTFd Jumbotron
 * Adapted from Ambient Canvas Backgrounds by Sean Free
...
function createCanvas() {
  container = document.querySelector('.pipeline-jumbotron');
  if (!container) {
    console.warn('Pipeline: .pipeline-jumbotron container not found');
    return;
  }
